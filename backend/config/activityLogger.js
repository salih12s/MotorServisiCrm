...
const ISLEM_TIPLERI = {
  ...
  MUSTERI_PASIFE_AL: 'MUSTERI_PASIFE_AL',
  MUSTERI_AKTIF_ET: 'MUSTERI_AKTIF_ET',
  CARI_HAREKET_EKLE: 'CARI_HAREKET_EKLE',
  CARI_HAREKET_TERS: 'CARI_HAREKET_TERS',
  // Gider İşlemleri
  GIDER_OLUSTUR: 'GIDER_OLUSTUR',
  GIDER_GUNCELLE: 'GIDER_GUNCELLE',
  GIDER_SIL: 'GIDER_SIL'
};
