...
function ProductsTableSection({
  ...
  return (
    <FormSectionCard icon={<ListIcon />} iconBg="info.lighter" iconColor="info.main" title="Eklenen Ürünler Tablosu">
      {isMobile ? (
      ...
      {parcalar.length > 0 && (
        <Box
          sx={{
            display: 'grid',
            gridTemplateColumns: { xs: '1fr', sm: isEdit ? (isAdmin ? '1fr 1fr 1fr' : '1fr') : '1fr' },
            gap: 1.5,
            mt: 1.5,
            p: 1.5,
            bgcolor: 'grey.50',
