...
import KullaniciIsEmriDetayDialog from './KullaniciIsEmriDetayDialog';
import KullaniciAktiviteDialog from './KullaniciAktiviteDialog';
import KullaniciIsEmirleriDialog from './KullaniciIsEmirleriDialog';
...
function Kullanicilar() {
  ...
  return (
    <Box>
      ...
      <KullaniciAktiviteDialog
        open={activityDialogOpen}
        onClose={() => setActivityDialogOpen(false)}
        isMobile={isMobile}
        user={selectedUser}
        userActivities={userActivities}
        getIslemTipiIcon={getIslemTipiIcon}
      />
